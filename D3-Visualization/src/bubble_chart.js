...
function bubbleChart() {
  ...
  var yearCenters = {
    Dermatology: { x: width / 3, y: height / 2 },
    AntiInfective: { x: width / 2, y: height / 2 },
    PainManagement: { x: 2 * width / 3, y: height / 2 }
  };

  // X locations of the year titles.
  var yearsTitleX = {
    Dermatology: 160,
    AntiInfective: width/2,
    PainManagement: width-160,
  };
